...
class riak (
  ...
  $bin_dir             = hiera('bin_dir', $riak::params::bin_dir),
  ...
  $lib_dir             = hiera('lib_dir', $riak::params::lib_dir),
  $data_dir            = hiera('data_dir', $riak::params::data_dir),
  $error_log           = hiera('error_log', $riak::params::error_log),
  $info_log            = hiera('info_log', $riak::params::info_log),
  $crash_log           = hiera('crash_log', $riak::params::crash_log),
